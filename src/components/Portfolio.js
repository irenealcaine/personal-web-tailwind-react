    ...
    <>
      ...
      <div className='' id='portfolio'>
        ...
        >
          ...
          <div className='pb-6 mx-2 py-2'>
            <img src={tailwind} alt="" className='h-48 w-80 mx-auto my-2 shadow-lg rounded-md hover:scale-105 hover:cursor-pointer transition-all duration-500 ease-in-out' />
