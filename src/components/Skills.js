      ...
      <div className='md:min-h-screen flex flex-col ' id='skills'>
        ...
        <div className='my-auto '>
          ...
          <div className='flex flex-col md:flex-row'>
            ...
            <Tabs selectedTabClassName='bg-violet-700 font-bold' className='md:w-1/3'>
              <TabList className='flex flex-wrap justify-center flex-col md:flex-row bg-violet-900 p-2 rounded-lg  w-5/6 mx-auto bg-opacity-60'>
              ...
              {skillsData.map((data, key) => {
                return (
                  <TabPanel>
                    <div className='flex flex-wrap justify-center border-2 border-violet-900 rounded-xl p-1 w-5/6 mx-auto mt-2'>
            ...
            <Tabs selectedTabClassName='bg-violet-700 font-bold' className='md:w-2/3'>
              <TabList className='flex justify-center flex-col md:flex-row bg-violet-900 p-2 rounded-lg mt-4 md:mt-0 w-5/6 mx-auto bg-opacity-60'>
              ...
              <TabPanel>
                <div className='border-2 border-violet-900 rounded-xl w-5/6 mx-auto mt-2 px-4 py-2'>
          ...
          <a href={CV} download="CV_Irene_Alcaine.pdf"><p className='md:text-xl mt-8 rounded-xl indent-4 md:w-1/2 w-5/6 mx-auto text-violet-300 text-center border-4 border-violet-900 py-2 hover:cursor-pointer hover:bg-violet-900 hover:text-white transition-all duration-500 ease-in-out'>Descargar CV</p></a>
