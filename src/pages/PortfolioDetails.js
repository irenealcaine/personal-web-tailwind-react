  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <div className="w-10/12 mx-auto mt-8 flex flex-wrap gap-4 justify-center">
          {portfolioData
            .filter((tech) =>
            ...
            .map((data, key) => {
              return (
                <Link
                  ...
                  key={key}
                  className="w-48 md:w-60 aspect-square group relative overflow-hidden border-2 border-violet-700 rounded-xl"
                >
